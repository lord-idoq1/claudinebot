    ...
    if not channel:
        ...
        async def _save(exc):
            ...
            await asst.send_message(
                ayra_bot.me.id, f"Failed to Create Log Channel due to {exc}.."
            )
        ...
        try:
            r = await ayra_bot(
                CreateChannelRequest(
                    title="Aʏʀᴀ ꭙ Uꜱᴇʀʙᴏᴛ​ Logs",
                    about="Uꜱᴇʀʙᴏᴛ Log Group",
                    megagroup=True,
                ),
            )
...
async def ready():
    ...
    if not udB.get_key("INIT_DEPLOY"):  # Detailed Message at Initial Deploy
        MSG = """ **Thanks for Deploying ᴀʏʀᴀ ꭙ ᴜꜱᴇʀʙᴏᴛ​!**
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
        PHOTO = "https://graph.org/file/a51b51ca8a7cc5327fd42.jpg"
        BTTS = Button.inline("• Click to Start •", "initft_2")
        udB.set_key("INIT_DEPLOY", "Done")
    else:
        MSG = f"**ᴀʏʀᴀ ꭙ ᴜꜱᴇʀʙᴏᴛ has been deployed!**\n➖➖➖➖➖➖➖➖➖➖\n**UserMode**: {inline_mention(ayra_bot.me)}\n**Assistant**: @{asst.me.username}\n➖➖➖➖➖➖➖➖➖➖\n**Support**: @stufsupport\n➖➖➖➖➖➖➖➖➖➖"
